...
public interface BookRepository extends JpaRepository<Book, UUID>{
	...
	List<Book> findAllByYear(Year publicationYear);
	...
	List<Book> findAllByTitleIsLikeIgnoreCaseAndYear(String title, Year publicationYear);
	...
	List<Book> findAllByYearAndAuthorIsLikeIgnoreCase(Year publicationYear, String author);
